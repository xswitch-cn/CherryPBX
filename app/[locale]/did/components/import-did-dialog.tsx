...
export function ImportDidDialog({
  open,
  onOpenChange,
  onImportSuccess,
}: {
  ...
  const handleImport = async () => {
    ...
    try {
        ...
        await new Promise<void>((resolve, _reject) => {
          ...
          fileReader.onload = async (event) => {
            try {
              ...
              try {
                await hotlinesApi.upload({ dids: newData });
                toast.success(ttt("Import Success") || "导入成功");
              } catch (error: any) {
                console.error("Failed to upload DID:", error);
      ...
      console.error("Failed to import dids:", error);
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                ...
                <Button
                  ...
                  onClick={() => document.getElementById("did-file-upload")?.click()}
                >
